...
class DoubleLayerShell:
    ...
    def __init__(self, numx=100, numy=100, save_interval=100):

        self.ectoderm = Shell(SMC(T=200, dt=0.0002, k2=0.4, s0=400, d=40e-4, v7=0.01), 
                              None, None, numx=numx, numy=numy, 
                              gip3x=20, gip3y=40, save_interval=None)
        self.endoderm = Shell(SMC(T=200, dt=0.0002, k2=0.4, s0=400, d=40e-4, v7=0.01), 
                              None, None, numx=numx, numy=numy, 
                              gip3x=10, gip3y=10, save_interval=None)

        self.ectoderm.init_stimulation_pattern('fast', 0, 10, 0, 100, 0) # CB Stimulation
        self.ectoderm.init_stimulation_pattern('slow', 0, 10, 40, 60, 0) # Bending Stimulation
        self.endoderm.init_stimulation_pattern('slow', 0, -1, 0, -1, 1000) # Active Elongation Stimulation
...
if __name__ == "__main__":
    ...
    df1.to_csv('/media/hengji/DATA/Data/Documents/hydramuscle/results/data/calcium/100x100_200s_cycle_k2_04_s0_400_d_40_v7_001_gip3x_20_gip3y_40_ecto.csv', index = False)
    time.sleep(600)
    df2.to_csv('/media/hengji/DATA/Data/Documents/hydramuscle/results/data/calcium/100x100_200s_cycle_k2_04_s0_400_d_40_v7_001_gip3x_20_gip3y_40_endo.csv', index = False)