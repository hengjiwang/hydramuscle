...
class Cell(HoferCell, FastCell, FluoEncoder):
    ...
    def rhs(self, y, t):
        ...
        c, s, r, ip, v, n, hv, hc, x, z, p, q, g, c1g, c2g, c3g, c4g = y

        dcdt = self.i_rel(c, s, ip, r) + self.i_leak(c, s) - self.i_serca(c) + self.i_in() - self.i_pmca(c) - self.i_out(c)\
            - 1e9 * self.i_cal(v, n, hv, hc) / (2 * self.F * self.d) - self.r_1(c, g, c1g) - self.r_2(c, c1g, c2g) \
        ...
        return [dcdt, dsdt, drdt, dipdt, dvdt, dndt, dhvdt, dhcdt, dxdt, dzdt, dpdt, dqdt, dgdt, dc1gdt, dc2gdt, dc3gdt, dc4gdt]
    ...
    def step(self):
        ...
        self.hc0, self.x0, self.z0, self.p0, self.q0, self.g0, self.c1g0, self.c2g0, self.c3g0, self.c4g0]
