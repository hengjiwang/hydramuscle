...
if __name__ == "__main__":
    ...
    df.to_csv('/media/hengji/DATA/Data/Documents/hydramuscle/results/data/calcium/100x100_100s_bending_k2_02_s0_200_v7_002_gip3x_10_gip3y_20.csv', index = False)