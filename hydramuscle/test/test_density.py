...
if __name__ == "__main__":
    ...
    ectoderm.set_stim_pattern("fast", xmin=0, xmax=30, ymin=0, ymax=1, stim_times=stims_fast)
    ...
    for i in range(20):
        ...
        ca = shell.run()
        ca = pd.DataFrame(ca)
        ca.to_hdf("../results/data/calcium/cross_layer_density/density_" + sys.argv[1] + "_" + str(i) + ".h5", 'calcium')
