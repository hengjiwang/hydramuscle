...
class DoubleLayerShell:
    ...
    def __init__(self, numx=200, numy=200, save_interval=100):
        ...
        self.endoderm.init_stimulation_pattern('slow', 0, -1, 0, -1, 4000)
    ...
    def run(self, stims_fast_ecto=[], stims_slow_ecto=[], stims_fast_endo=[], stims_slow_endo=[10]):
...
if __name__ == "__main__":
    ...
    df1.to_csv('/media/hengji/DATA/Data/Documents/hydramuscle/results/data/calcium/200x200_100s_elongation_ecto2.csv', index = False)
    time.sleep(600)
    df2.to_csv('/media/hengji/DATA/Data/Documents/hydramuscle/results/data/calcium/200x200_100s_elongation_endo2.csv', index = False)