...
if __name__ == "__main__":
    force = load_data('/media/hengji/DATA/Data/Documents/hydramuscle/results/data/force/200x200_100s_bending3.csv')
    ...
    df.to_csv('/media/hengji/DATA/Data/Documents/hydramuscle/results/data/force/200x200_100s_bending3_averaged.csv', index = False)