...
if __name__ == "__main__":
    ...
    df1.to_csv('../../results/data/calcium/200x200_100s_contraction_ecto.csv', index = False)
    time.sleep(600)
    df2.to_csv('../../results/data/calcium/200x200_100s_contraction_endo.csv', index = False)