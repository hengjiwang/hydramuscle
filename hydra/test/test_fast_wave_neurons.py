...
def run_shell(numx, numy, seed, gip3x, gip3y, gcx=1000, gcy=1000, sparsity=0.002, gc=1000, gip3=5, pathway="Fast",
              save_interval=100, density=0.1, total_prop_time=0.1, save_dir="../results/data/calcium", **kargs):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--total_prop_time', type=float, default=0.1)
    ...
    run_shell(args.numx, args.numy, args.seed, args.gip3x, args.gip3y,
              ...
              args.pathway, args.save_interval, args.density, args.total_prop_time, args.save_dir,
