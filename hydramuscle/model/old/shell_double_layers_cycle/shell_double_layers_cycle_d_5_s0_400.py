...
class DoubleLayerShell:
    ...
    def __init__(self, numx=200, numy=200, save_interval=100):
        ...
        self.ectoderm = Shell(SMC(T=200, dt=0.0002, k2=0.05, s0=100, d=5e-4, v7=0.015), 
                              None, None, numx=numx, numy=numy, 
                              gip3x=5, gip3y=40, save_interval=None)
        self.endoderm = Shell(SMC(T=200, dt=0.0002, k2=0.05, s0=400, d=5e-4, v7=0., 
                                  active_v8=0.2, k9=0.002, gkca=0), 
                              None, None, numx=numx, numy=numy, 
        ...
        self.ectoderm.init_stimulation_pattern('fast', 0, int(self.numx/10), 0, self.numy, 0) # CB Stimulation
        self.ectoderm.init_stimulation_pattern('slow', 0, int(self.numx/10), int(self.numy/2 - self.numy/10), int(self.numy/2 + self.numy/10), 0) # Bending Stimulation
        self.endoderm.init_stimulation_pattern('slow', 0, -1, 0, -1, int(0.1*self.num2)) # Active Elongation Stimulation
...
if __name__ == "__main__":
    ...
    df1.to_csv('/media/hengji/DATA/Data/Documents/hydramuscle/results/data/calcium/200x200_200s_shell_double_layers_cycle_d_5_s0_400_v7_0015_k9_0002_ecto.csv', index = False)
    time.sleep(600)
    df2.to_csv('/media/hengji/DATA/Data/Documents/hydramuscle/results/data/calcium/200x200_200s_shell_double_layers_cycle_d_5_s0_400_v7_0015_k9_0002_endo.csv', index = False)