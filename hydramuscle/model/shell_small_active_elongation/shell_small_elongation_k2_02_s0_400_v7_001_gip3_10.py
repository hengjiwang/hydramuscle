...
if __name__ == "__main__":
    model = Shell(SMC(T=100, dt=0.0002, k2=0.2, s0=400, d=40e-4, v7=0.01), 
    'elongation', numx=100, numy=100)
    sol = model.run([-100], [10])
    df = pd.DataFrame(sol[:,0:model.numx*model.numy])
    df.to_csv('/media/hengji/DATA/Data/Documents/hydramuscle/results/data/calcium/100x100_100s_elongation_k2_02_s0_400_v7_001_gip3_10.csv', index = False)