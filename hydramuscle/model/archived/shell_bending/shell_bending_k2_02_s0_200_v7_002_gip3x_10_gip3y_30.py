...
class Shell:
    ...
    def init_stimulation_pattern(self, behavior):
        if behavior == 'contraction burst':
            ...
            self.s_ip = self.generate_indices(0, 10, 90, 110)
        else:
            return
...
if __name__ == "__main__":
    ...
    df.to_csv('/media/hengji/DATA/Data/Documents/hydramuscle/results/data/calcium/200x200_100s_bending_k2_02_s0_200_v7_002_gip3x_10_gip3y_30.csv', index = False)