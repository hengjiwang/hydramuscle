...
class Shell:
    ...
    def __init__(self, cell, numx=200, numy=200, save_interval=50):
        self.cell = cell
        self.T = cell.T
        self.dt = cell.dt
        self.gcx = 1000
        ...
        self.init_stimulation_pattern('fast', 0, 5, 0, 50, 0) # CB Stimulation
        self.init_stimulation_pattern('slow', 0, 5, 20, 30, 0) # Bending Stimulation
