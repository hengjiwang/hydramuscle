...
class Shell:
    ...
    def __init__(self, cell, numx, numy, save_interval):
        ...
        self.init_stimulation_pattern('slow', 0, int(self.numx/10), int(self.numy/2 - self.numy/10), int(self.numy/2 + self.numy/10), 0) # Bending Stimulation
