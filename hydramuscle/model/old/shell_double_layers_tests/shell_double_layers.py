...
class DoubleLayerShell:
    ...
    def __init__(self, numx=200, numy=200, save_interval=100):
        ...
        self.ectoderm = Shell(SMC(T=100, dt=0.0002, k2=0.1, s0=100, d=40e-4, v7=0.005), 
                              None, None, numx=numx, numy=numy, save_interval=None)
        self.endoderm = Shell(SMC(T=100, dt=0.0002, k2=0.1, s0=100, d=40e-4, v7=0.005), 
                              None, None, numx=numx, numy=numy, save_interval=None)

        self.ectoderm.init_stimulation_pattern('fast', 0, 1, 0, 200, 0)
    ...
    def run(self, stims_fast_ecto=[0,5,9,13,17,21,25,30,35,40], stims_slow_ecto=[], stims_fast_endo=[], stims_slow_endo=[]):
...
if __name__ == "__main__":
    ...
    df2 = pd.DataFrame(sol[:,14*model.num2:15*model.num2])
    df1.to_csv('/media/hengji/DATA/Data/Documents/hydramuscle/results/data/calcium/200x200_100s_contraction_ecto.csv', index = False)
    time.sleep(600)
    df2.to_csv('/media/hengji/DATA/Data/Documents/hydramuscle/results/data/calcium/200x200_100s_contraction_endo.csv', index = False)