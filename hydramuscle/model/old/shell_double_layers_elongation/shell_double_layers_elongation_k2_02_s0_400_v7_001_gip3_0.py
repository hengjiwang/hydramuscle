...
class DoubleLayerShell:
    ...
    def __init__(self, numx=200, numy=200, save_interval=100):
        ...
        self.ectoderm = Shell(SMC(T=100, dt=0.0002, k2=0.2, s0=400, d=40e-4, v7=0.01), 
                              None, None, numx=numx, numy=numy, 
                              gip3x=10, gip3y=10, save_interval=None)
        self.endoderm = Shell(SMC(T=100, dt=0.0002, k2=0.2, s0=400, d=40e-4, v7=0.01), 
                              None, None, numx=numx, numy=numy, 
                              gip3x=10, gip3y=10, save_interval=None)
...
if __name__ == "__main__":
    ...
    df1.to_csv('/media/hengji/DATA/Data/Documents/hydramuscle/results/data/calcium/200x200_100s_elongation_ecto.csv', index = False)
    time.sleep(600)
    df2.to_csv('/media/hengji/DATA/Data/Documents/hydramuscle/results/data/calcium/200x200_100s_elongation_endo.csv', index = False)