...
class FluoEncoder:
    ...
    def __init__(self, c, T=100, dt=0.001):
        ...
        self.k4n = 2 # 3 # 5.8
        self.c = c
        self.g0 = 0.6405916841274526 # 3.28088468
        self.c1g0 = 6.405916841396227 # 4.10110585
        self.c2g0 = 0.2706499865546659 # 0.01690456
        self.c3g0 = 0.002977149875468799 # 7.87924326e-05
        self.c4g0 = 0.07956433047838572 # 0.00072611
        self.phi0 = 1
        self.phi1 = 1
        self.phi2 = 1
        self.phi3 = 1
