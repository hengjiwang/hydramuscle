...
class DoubleLayerShell:
    ...
    def __init__(self, numx=100, numy=100, save_interval=100):
        ...
        self.ectoderm = Shell(SMC(T=100, dt=0.0002, k2=0.2, s0=200, d=40e-4, v7=0.02), 
                              None, None, numx=numx, numy=numy, 
                              gip3x=2, gip3y=2, save_interval=None)
        self.endoderm = Shell(SMC(T=100, dt=0.0002, k2=0.2, s0=200, d=40e-4, v7=0.02), 
                              None, None, numx=numx, numy=numy, 
                              gip3x=2, gip3y=2, save_interval=None)

        self.ectoderm.init_stimulation_pattern('slow', 0, 10, 40, 60, 0)
    ...
    def run(self, stims_fast_ecto=[], stims_slow_ecto=[10], stims_fast_endo=[], stims_slow_endo=[]):
...
if __name__ == "__main__":
    ...
    df1.to_csv('/media/hengji/DATA/Data/Documents/hydramuscle/results/data/calcium/100x100_100s_bending_ecto_small.csv', index = False)
    time.sleep(600)
    df2.to_csv('/media/hengji/DATA/Data/Documents/hydramuscle/results/data/calcium/100x100_100s_bending_endo_small.csv', index = False)