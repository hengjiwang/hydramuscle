...
class DoubleLayerShell:
    ...
    def __init__(self, numx=200, numy=200, save_interval=100):
        ...
        self.ectoderm = Shell(SMC(T=200, dt=0.0002, k2=0.05, s0=60, d=10e-4, v7=0.02), 
                              ...
                              gip3x=10, gip3y=40, save_interval=None, v_scale=0.02)
        self.endoderm = Shell(SMC(T=200, dt=0.0002, k2=0.05, s0=200, d=10e-4, v7=0., 
                                  active_v8=0.05, k9=0.01, gkca=0), 
                              None, None, numx=numx, numy=numy, 
                              gip3x=10, gip3y=10, save_interval=None, v_scale=0.02)
...
if __name__ == "__main__":
    ...
    df1.to_csv('/media/hengji/DATA/Data/Documents/hydramuscle/results/data/calcium/200x200_200s_cycle_diff_s0_gkca_vscale_002_ecto.csv', index = False)
    time.sleep(600)
    df2.to_csv('/media/hengji/DATA/Data/Documents/hydramuscle/results/data/calcium/200x200_200s_cycle_diff_s0_gkca_vscale_002_endo.csv', index = False)