...
class DoubleLayerShell:
    ...
    def __init__(self, numx=200, numy=200, save_interval=100):
        ...
        self.ectoderm = Shell(SMC(T=200, dt=0.0002, k2=0.05, s0=60, d=5e-4, v7=0.02), 
                              None, None, numx=numx, numy=numy, 
                              gip3x=10, gip3y=40, save_interval=None)
        self.endoderm = Shell(SMC(T=200, dt=0.0002, k2=0.05, s0=200, d=5e-4, v7=0., 
...
if __name__ == "__main__":
    ...
    df1.to_csv('/media/hengji/DATA/Data/Documents/hydramuscle/results/data/calcium/200x200_200s_cycle_diff_s0_gkca_d_5_ecto.csv', index = False)
    time.sleep(600)
    df2.to_csv('/media/hengji/DATA/Data/Documents/hydramuscle/results/data/calcium/200x200_200s_cycle_diff_s0_gkca_d_5_endo.csv', index = False)