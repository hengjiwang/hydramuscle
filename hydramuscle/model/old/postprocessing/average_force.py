...
if __name__ == "__main__":
    force = load_data('/media/hengji/DATA/Data/Documents/hydramuscle/results/data/force/200x200_100s_for_cosyne_cb.csv')
    ...
    df.to_csv('/media/hengji/DATA/Data/Documents/hydramuscle/results/data/force/200x200_100s_for_cosyne_cb_averaged.csv', index = False)