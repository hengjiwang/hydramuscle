...
class DoubleLayerShell:
    ...
    def __init__(self, numx=200, numy=200, save_interval=100):
        ...
        self.ectoderm = Shell(SMC(T=100, dt=0.0002, k2=0.1, s0=100, d=40e-4, v7=0.02), 
                              None, None, numx=numx, numy=numy, 
                              gip3x=2, gip3y=2, save_interval=None)
        self.endoderm = Shell(SMC(T=100, dt=0.0002, k2=0.1, s0=100, d=40e-4, v7=0.02), 
                              None, None, numx=numx, numy=numy, 
                              gip3x=2, gip3y=2, save_interval=None)
...
if __name__ == "__main__":
    ...
    df1.to_csv('../../results/data/calcium/200x200_100s_bending_ecto2.csv', index = False)
    time.sleep(600)
    df2.to_csv('../../results/data/calcium/200x200_100s_bending_endo2.csv', index = False)

    # Version 2: test translayer gip3=0 & v7=0.02 