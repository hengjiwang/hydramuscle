...
class DoubleLayerShell:
    ...
    def __init__(self, numx=100, numy=100, save_interval=100):
        ...
        self.ectoderm = Shell(SMC(T=200, dt=0.0002, k2=0.2, s0=200, d=20e-4, v7=0.02), 
                              None, None, numx=numx, numy=numy, 
                              gip3x=10, gip3y=30, save_interval=None)
        self.endoderm = Shell(SMC(T=200, dt=0.0002, k2=0.2, s0=200, d=20e-4, v7=0.02), 
                              None, None, numx=numx, numy=numy, 
...
if __name__ == "__main__":
    ...
    df1.to_csv('/media/hengji/DATA/Data/Documents/hydramuscle/results/data/calcium/100x100_200s_cycle_ecto_s0_200_d_20_v7_002.csv', index = False)
    time.sleep(600)
    df2.to_csv('/media/hengji/DATA/Data/Documents/hydramuscle/results/data/calcium/100x100_200s_cycle_endo_s0_200_d_20_v7_002.csv', index = False)