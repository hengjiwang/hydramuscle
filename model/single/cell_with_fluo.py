...
class Cell(SlowCell, FastCell, FluoEncoder):
    # This is a intracellular model without L-type calcium channel
    def __init__(self, T = 20, dt = 0.001, k2 = 0.05, s0 = 200, d = 40e-4, v7 = 0.03, v41 = 0.5):
        # Parameters
    ...
    def step(self, stims_v = [101,103,105,107,109,111,113,115,117,119], stims_ip = [10, 30, 50]):
        ...
        self.g0, self.c1g0, self.c2g0, self.c3g0, self.c4g0]
