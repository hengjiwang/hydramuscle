...
if __name__ == "__main__":
    ...
    df1.to_csv('../../results/data/calcium/200x200_100s_contraction_ecto2.csv', index = False)
    time.sleep(600)
    df2.to_csv('../../results/data/calcium/200x200_100s_contraction_endo2.csv', index = False)

    # Version 2: test translayer gc=0