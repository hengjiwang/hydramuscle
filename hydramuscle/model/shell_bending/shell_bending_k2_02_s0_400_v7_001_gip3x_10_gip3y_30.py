...
if __name__ == "__main__":
    model = Shell(SMC(T=200, dt=0.0002, k2=0.2, s0=400, d=40e-4, v7=0.01), 
    'bending', numx=200, numy=200)
    sol = model.run([-100], [10])
    df = pd.DataFrame(sol[:,0:model.numx*model.numy])
    df.to_csv('/media/hengji/DATA/Data/Documents/hydramuscle/results/data/calcium/200x200_200s_bending_k2_02_s0_400_v7_001_gip3x_10_gip3y_30.csv', index = False)