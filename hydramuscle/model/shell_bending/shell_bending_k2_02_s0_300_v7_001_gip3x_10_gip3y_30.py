...
if __name__ == "__main__":
    ...
    df.to_csv('/media/hengji/DATA/Data/Documents/hydramuscle/results/data/calcium/200x200_100s_bending_k2_02_s0_300_v7_001_gip3x_10_gip3y_30.csv', index = False)