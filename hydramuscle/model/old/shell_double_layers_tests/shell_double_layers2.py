...
class DoubleLayerShell:
    ...
    def __init__(self, numx=200, numy=200, save_interval=100):
        ...
        self.ectoderm = Shell(SMC(T=100, dt=0.0002, k2=0.1, s0=600, d=40e-4, v7=0.005), 
                              None, None, numx=numx, numy=numy, save_interval=None)
        self.endoderm = Shell(SMC(T=100, dt=0.0002, k2=0.1, s0=600, d=40e-4, v7=0.005), 
                              None, None, numx=numx, numy=numy, save_interval=None)

        self.ectoderm.init_stimulation_pattern('slow', 0, 10, 80, 120, 0)
    ...
    def run(self, stims_fast_ecto=[], stims_slow_ecto=[1], stims_fast_endo=[], stims_slow_endo=[]):
...
if __name__ == "__main__":
    ...
    df1.to_csv('../../results/data/calcium/200x200_100s_bending_ecto.csv', index = False)
    time.sleep(600)
    df2.to_csv('../../results/data/calcium/200x200_100s_bending_endo.csv', index = False)