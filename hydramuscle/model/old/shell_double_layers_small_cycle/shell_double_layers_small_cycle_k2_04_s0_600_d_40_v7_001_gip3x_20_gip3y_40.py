...
class DoubleLayerShell:
    ...
    def __init__(self, numx=100, numy=100, save_interval=100):
        ...
        self.ectoderm = Shell(SMC(T=200, dt=0.0002, k2=0.4, s0=600, d=40e-4, v7=0.01), 
                              None, None, numx=numx, numy=numy, 
                              gip3x=20, gip3y=40, save_interval=None)
        self.endoderm = Shell(SMC(T=200, dt=0.0002, k2=0.4, s0=600, d=40e-4, v7=0.01), 
                              None, None, numx=numx, numy=numy, 
...
if __name__ == "__main__":
    ...
    df1.to_csv('/media/hengji/DATA/Data/Documents/hydramuscle/results/data/calcium/100x100_200s_cycle_k2_04_s0_600_d_40_v7_001_gip3x_20_gip3y_40_ecto.csv', index = False)
    time.sleep(600)
    df2.to_csv('/media/hengji/DATA/Data/Documents/hydramuscle/results/data/calcium/100x100_200s_cycle_k2_04_s0_600_d_40_v7_001_gip3x_20_gip3y_40_endo.csv', index = False)