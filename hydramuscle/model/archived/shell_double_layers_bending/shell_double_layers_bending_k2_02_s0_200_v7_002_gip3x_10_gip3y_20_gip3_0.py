...
class DoubleLayerShell:
    ...
    def __init__(self, numx=200, numy=200, save_interval=100):
        ...
        self.ectoderm.init_stimulation_pattern('slow', 0, 10, 90, 110, 0)
...
if __name__ == "__main__":
    ...
    df1.to_csv('/media/hengji/DATA/Data/Documents/hydramuscle/results/data/calcium/200x200_100s_bending_ecto.csv', index = False)
    time.sleep(600)
    df2.to_csv('/media/hengji/DATA/Data/Documents/hydramuscle/results/data/calcium/200x200_100s_bending_endo.csv', index = False)