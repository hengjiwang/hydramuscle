...
def run_shell(numx, numy, seed, gip3x, gip3y, gcx=1000, gcy=1000, sparsity=0.002, gc=1000, gip3=5, pathway="Both",
    ...
    stims_fast = [0.0, 8.75, 18.25, 24.25, 27.25, 31.0, 34.5, 37.75, 41.25, 44.75, 52.0, 58.25,
                 116.75, 118.5, 126.5, 132.5, 136.0, 139.0, 142.5, 146.25, 150.75, 158.5, 160.5,
                 248.5, 256.0, 261.25, 265.0, 268.5, 271.75, 275.0, 277.0, 278.75, 284.0,
                 371.0, 380.25, 385.5, 389.25, 392.5, 395.5, 399.0, 402.5, 406.25, 411.5, 417.75, 420.25]
    stims_slow1 = []
    stims_slow2 = []
    # stims_slow1 = [15]
    # stims_slow2 = []
